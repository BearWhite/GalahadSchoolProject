...
use Biblio\EntityBundle\Form\LivreType;
...
class LivreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BiblioEntityBundle:Livre')->findAll();

        return $this->render('BiblioEntityBundle:Livre:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BiblioEntityBundle:Livre:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('BiblioEntityBundle:Livre:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BiblioEntityBundle:Livre:edit.html.twig', array(
            'entity'      => $entity,
